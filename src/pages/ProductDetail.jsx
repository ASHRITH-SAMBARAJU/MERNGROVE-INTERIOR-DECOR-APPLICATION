      ...
      <div className="container max-w-5xl mx-auto py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
          ...
          <div className="space-y-6">
            ...
            <div>
              <div className="flex items-center gap-2 mb-2">
                <span className="text-sm px-2 py-1 bg-secondary rounded-sm">{product.category}</span>
                {product.newArrival && (
                  <span className="text-sm px-2 py-1 bg-accent rounded-sm">New</span>
                )}
              </div>

              <h1 className="text-2xl font-medium">{product.name}</h1>
              <div className="mt-2 text-xl">{formatter.format(product.price)}</div>
            </div>
              ...
              >
                <Heart 
                  className={`h-5 w-5 mr-2 ${
                    isFavorite(product.id) ? "fill-red-500" : "stroke-white"
                  }`}
                />
